window.addEventListener('DOMContentLoaded', async(event) => {
    ...
    //const segmenters = new Map(SEG_IDS.map(g=>[g, new Intl.Segmenter('ja', { granularity:g })]))
    //const segmenters = new Map(SEG_IDS.map(g=>[g, new Intl.Segmenter(window.navigator.language, { granularity:g })]))
    //const segmenters = new Map(SEG_IDS.map(g=>[g, new Intl.Segmenter('en', { granularity:g })]))
